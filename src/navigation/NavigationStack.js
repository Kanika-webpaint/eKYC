        ...
        {isLogged ? (
          <>
            <Stack.Screen
              ...
              name="DashboardAdmin"
              component={routeNames.DashboardAdmin}
            />
            <Stack.Screen
              options={{headerShown: false}}
              name="CreateUser"
              component={routeNames.CreateUser}
            />
            <Stack.Screen
              options={{headerShown: false}}
              name="UsersList"
              component={routeNames.UserList}
            />
            <Stack.Screen
              options={{headerShown: false}}
              name="UserProfile"
              component={routeNames.UserProfile}
            />
            <Stack.Screen
              options={{headerShown: false}}
              name="CurrentPlan"
              component={routeNames.CurrentPlan}
            />
            <Stack.Screen
              options={{headerShown: false}}
              name="Settings"
              component={routeNames.Settings}
            />
            <Stack.Screen
              options={{headerShown: false}}
              name="AdminProfile"
              component={routeNames.AdminProfile}
            />
            <Stack.Screen
              options={{headerShown: false}}
              name="ChangePassword"
          ...
          <>
            <Stack.Screen
              options={{headerShown: false}}
              name="IdScreen"
              component={routeNames.IdScreen}
            />
            <Stack.Screen
              options={{headerShown: false}}
              name="Liveness"
              component={routeNames.Liveness}
            />
          </>
        ) : (
          <>
            ...
            <Stack.Screen
              options={{headerShown: false}}
              name="LoginAdmin"
              component={routeNames.LoginAdmin}
            />
            <Stack.Screen
              options={{headerShown: false}}
              name="Plan"
              component={routeNames.Plan}
            />
            <Stack.Screen
              options={{headerShown: false}}
              name="Checkout"
              component={routeNames.Checkout}
            />
            <Stack.Screen
              options={{headerShown: false}}
              name="PlanDetails"
              component={routeNames.PlanDetails}
            />
            <Stack.Screen
              options={{headerShown: false}}
              name="SuccessScreen"
              component={routeNames.SuccessScreen}
            />
          </>
        )}
      </Stack.Navigator>
