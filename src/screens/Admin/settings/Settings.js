        ...
        <SafeAreaView style={styles.safeArea}>
            ...
            <ScrollView keyboardShouldPersistTaps='handled'>
                ...
                <View style={{ margin: 20 }}>
                    <TouchableOpacity style={styles.input} onPress={() => navigation.navigate('AdminProfile')}>
                        <View style={{ flexDirection: 'row' }}>
                            <Image source={userRed} style={{ height: 20, width: 20, resizeMode: 'contain', alignSelf: 'center' }}></Image>
                    ...
                    <TouchableOpacity style={styles.input} onPress={() => buttonAlert()}>
                        <View style={{ flexDirection: 'row' }} >
                            <Image source={logout} style={{ height: 20, width: 20, resizeMode: 'contain', alignSelf: 'center' }}></Image>
