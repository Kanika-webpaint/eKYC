  ...
  const handleSendCode = async numberWithCode => {
    if (numberWithCode) {
      ...
      try {
        ...
        if (confirmResult && confirmResult._verificationId) {
      ...
      <View style={styles.bottomView}>
        <TouchableOpacity style={styles.codeView} onPress={() => codeResend()}>
          <Text style={styles.codeText}>
            You should've received your code via SMS.
          </Text>
          <Text style={styles.contactText}>
            If you haven't received a code, please contact {'\n'} your agent to
            request a new one.
          </Text>
        </TouchableOpacity>
      </View>
        ...
        <ScrollView
          ...
          <Image
            ...
            style={{
              ...
              width: '60%',
              resizeMode: 'contain',
              marginTop: isPotrait ? 0 : '3%',
            }}
          />
          <MobileNumberCodeVerification
            verificationImageSource={verification}
            textFirst={'To begin, Please enter your'}
            ...
            <>
              ...
              {showError && (
                <View style={{marginLeft: 33, marginTop: 5}}>
                  <Text style={{color: colors.app_red}}>
